  ...
  return (
    <>
      <section className="homePage">
        <h3 className="h3header"> AltSchool Second Semester Examination</h3>
...
<div style={{marginTop: "20px"}}>
        ...
        <p>
          ...
          useReducer that implements a counter with the four evident features in
          the custom hook - increment, decrement, reset, setValue. Implement a
